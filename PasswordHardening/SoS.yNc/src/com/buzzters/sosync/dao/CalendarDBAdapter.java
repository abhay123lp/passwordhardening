...
public class CalendarDBAdapter {
	...
	private static final String DATABASE_CREATE = "create table event_table(_cid integer primary key autoincrement,event text not null,starttime text not null,endtime text not null,allday text not null);";
